...
const Navigation = ({img, name, price}) => {
    ...
    return(
        <header className=" fixed left-0 z-40 top-0 w-full bg-white  ">
        <nav   className="flex flex-row items-center justify-between h-24 border-b-[1px] border-b-slate-300 w-full">
            ...
            <ul   className=" h-full basis-6/12 items-center justify-between flex mt-10 mb-4 mr-10  ">
                ...
                <li className=" h-9 text-center text-[#a91d3a] text-2xl font-bold font-mont hover:border-b-2 hover:border-b-[#a91d3a]">
                    <Link to="/about_us">VỀ CHÚNG TÔI</Link></li>
            </ul>
            
            <div className=" basis-3/12 flex flex-row justify-items-center rounded-[8px] shadow border items-center w-fit mt-4 ">
                
                    <img className="inline-block m-2" src={Search} alt="search"/>
                    <span >
                        <input placeholder="Tìm kiếm" className="m-2 focus:outline-none"></input>
                    </span>
                    
            </div>
            <div className=" basis-1/12 flex flex-row mt-6 ml-10 ">
