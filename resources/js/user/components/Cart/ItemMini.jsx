...
const ItemMini = ({product}) => {
    return(
        <div className="w-11/12 flex flex-row border-b-[1px] border-[#C4C4C4] ">
            <img className="w-20 h-full rounded-lg border-black border mb-2" src={product.img} alt="img" />
            <div className="flex flex-col pl-2 gap-1">
                {/* Thông tin sản phẩm */}
                <div className="w-full text-black text-xs font-semibold">{product.name}</div>
                ...
                <div className="flex flex-row gird grid-cols-2 justify-between">
                    ...
                    <div> 
                        ...
                        <div className="flex flex-row text-black text-lg font-bold pt-1">
                            ...
                            <div className="text-center text-black text-xs font-normal border border-[#c4c4c4] bg-[#d9d9d9] mx-[1px] px-1 pt-[2px] ">{product.quality}</div>
                            <button className="h-5 border border-[#c4c4c4] bg-[#d9d9d9] px-1">
                    ...
                    <div className=" justify-items-center">
                        {/* Giá sản phẩm */}
                        <div className=" text-[#a91d3a] text-sm font-bold ">{product.price}</div>
                        {/* Xóa sản phẩm */}
