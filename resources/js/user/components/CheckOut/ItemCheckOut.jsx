...
const ItemCheckOut = ({product}) => {
    return(
        <div className="w-full flex flex-row border-b-[1px] border-[#C4C4C4] mt-4">
            <img className="w-24 h-full rounded-lg  mb-2" src={product.productImage} alt="img" />
            <div className="w-full flex flex-col pl-2">
                {/* Thông tin sản phẩm */}
                <div className="h-12 content-center text-black text-base font-medium ">{product.productName}</div>
