...
const Footer = () => {
    return(
        <div className=" mt-16 flex desktop:flex-row ipad:flex-row mobile:flex-col mobile:pl-4 justify-items-center justify-between bg-[#151515] w-full pb-10 font-Public ">
            ...
            <div className='w-full flex desktop:flex-row ipad:flex-row mobile:flex-col max-w-[1557px]'>
                <div className="desktop:w-[50%] mt-9">
                    <ul className=" ">
                ...
                <div  className="desktop:w-[25%] desktop:justify-items-center  mt-9 ">
                    <div className="">
                        <ul className="w-[300]">
                ...
                <div className="desktop:w-[25%] desktop:justify-items-center ipad:justify-items-center desktop:ml-6 ipad:ml-6 mt-8">
