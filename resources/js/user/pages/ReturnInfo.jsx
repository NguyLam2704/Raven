        ...
        <div className="w-full">
            ...
            <div className="w-full justify-items-center mt-[90px] ">
                <div className='w-8/12 justify-items-center pt-5'>
                    ...
                    <div className='w-full text-center text-5xl font-bold py-10 '>ĐỔI TRẢ SẢN PHẨM</div>
                    ...
                    <ol class=" w-full list-decimal list-inside">
                        ...
                        <li className="text-lg text-black font-bold py-3">
                            Quy định thời gian:
                            <ul className="list-disc list-inside ml-5 text-lg text-black font-medium"> 
                        ...
                        <li className="text-lg text-black font-bold py-5">
                            Quy trình đổi trả:
                            <ul className="list-disc list-inside ml-5 text-lg text-black font-medium py-1"> 
