...
const AboutUs = () => {
    ...
    return(
        <div>
            <Navigation/>
            <div className='h-full w-full border max-w-[1557px] mx-auto'> 
                ...
                <div className='w-full justify-items-center pt-16 '>            
                ...
                <div className='w-full h-96  justify-items-center pt-16 mb-30'>
                    ...
                    <div className=' w-10/12 pt-1 flex flow-row justify-between text-xl font-bold text-[#a91d3a]'>
                        <div>2020</div>
                        <div ></div>
                        <div>2022</div>
                        <div ></div>
                        ...
                        { is2021 && (
                            <div className='w-10/12 text-justify text-xl font-semibold pt-5 pb-5 '>
                            <div className='text-2xl font-bold text-[#a91d3a]'> 2021 - Mở Rộng Quy Mô</div>
                        ...
                        { is2022 && (
                            <div className='w-10/12 text-justify text-xl font-semibold pt-5 pb-5 '>
                            <div className='text-2xl font-bold text-[#a91d3a]'> 2022 - Đa Dạng Hóa Sản Phẩm</div>
                        ...
                        { is2023 && (
                            <div className='w-10/12 text-justify text-xl font-semibold pt-5 pb-5 '>
                            <div className='text-2xl font-bold text-[#a91d3a]'> 2023 - Hợp Tác Chiến Lược: </div>
                        ...
                        { is2024 && (
                            <div className='w-10/12 text-justify text-xl font-semibold pt-5 pb-5 '>
                            <div className='text-2xl font-bold text-[#a91d3a]'> 2024 - Tiếp Tục Sáng Tạo</div>
