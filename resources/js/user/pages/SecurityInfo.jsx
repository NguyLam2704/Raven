        ...
        <div className="w-full">
            ...
            <div className="w-full justify-items-center mt-[90px] ">
                <div className='w-8/12 justify-items-center pt-5'>
                    ...
                    <div className='w-full text-center text-5xl font-bold py-10 '>BẢO MẬT THÔNG TIN</div>
                    ...
                    <ol class=" w-full list-decimal list-inside">
                        <li className="text-lg text-black font-bold py-3 mt-10">
                            ...
                            <div  className="text-lg text-black font-normal ml-5 py-2">Raven thu thập thông tin cá nhân bao gồm họ tên, email, số điện thoại, địa chỉ liên lạc và các thông tin khác khi khách hàng đăng ký tài khoản, đặt hàng hoặc liên hệ trên website. Mục đích thu thập nhằm:</div>
                        ...
                        <li className="text-lg text-black font-bold py-3">
                            ...
                            <div  className="text-lg text-black font-normal ml-5 py-2">Thông tin khách hàng chỉ được sử dụng trong nội bộ Raven để:</div>
                            <ul className="list-disc list-inside ml-8 text-lg text-black font-medium"> 
                        ...
                        <li className="text-lg text-black font-bold py-5">
                            ...
                            <div  className="text-lg text-black font-normal ml-5 py-2">Thông tin cá nhân sẽ được lưu trữ trong hệ thống đến khi khách hàng yêu cầu hủy hoặc không còn cần thiết cho mục đích sử dụng.</div>
                        </li>
                        <li className="text-lg text-black font-bold py-5">
                        ...
                        <li className="text-lg text-black font-bold py-5">
                            ...
                            <div  className="text-lg text-black font-normal ml-5 py-2">Khách hàng có quyền:</div>
                            <ul className="list-disc list-inside ml-8 text-lg text-black font-medium"> 
                                <li className="py-1">Yêu cầu kiểm tra, chỉnh sửa hoặc hủy thông tin cá nhân.</li> 
                        ...
                        <li className="text-lg text-black font-bold py-5">
                            ...
                            <div  className="text-lg text-black font-normal ml-5 py-2">Trong trường hợp có khiếu nại, khách hàng vui lòng liên hệ qua các kênh liên lạc trên. Raven cam kết xử lý kịp thời và bảo vệ quyền lợi khách hàng.</div>
                        </li>
                    </ol>
                </div>
