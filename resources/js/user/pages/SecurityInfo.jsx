        ...
        <div className="w-full bg-white font-Public">
            ...
            <div className="w-full justify-items-center mt-[90px] ">
                <div className='desktop:w-8/12 ipad:w-9/12 mobile:w-11/12 justify-items-center pt-5'>
                    ...
                    <div className='w-full text-[#1E0342] text-center desktop:text-4xl ipad:text-3xl font-bold py-6 '>BẢO MẬT THÔNG TIN</div>
                    <div className='w-full border-b-2 text-[#1E0342] border-black text-center desktop:text-2xl ipad:text-xl font-bold py-5 '>RAVEN</div>                    
