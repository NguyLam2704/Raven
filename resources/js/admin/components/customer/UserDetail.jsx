...
const UserDetail = ({UserDetail, onClose}) => {
    ...
    return (
        <div className={`fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center transition-opacity duration-500 ${showModal ? 'opacity-100' : 'opacity-0'} z-10`}>
                ...
                <div className="border bg-white rounded-lg border-[#0E46A3]">     
                    ...
                    <div className="desktop:flex">
                        ...
                        <div className="desktop:w-[40%]">
                            <div className="w-[95%] h-auto mobile:mx-2 desktop:ml-4 my-4 bg-white rounded-[10px] border border-[#0E46A3]" >
                           ...
                           <div className="w-[95%] h-auto  ml-4 my-4 bg-white rounded-[10px] border border-[#0E46A3]" >
                        ...
                        <div className="desktop:w-[60%]">
                            ...
                            <div className="w-[95%] h-auto max-h-[680px] mobile:mx-2 desktop:ml-4 my-4 bg-white rounded-[10px] border border-[#0E46A3]" >
