                ...
                <div className="border bg-white rounded-lg border-[#C73659]">     
                    ...
                    <div className="desktop:flex">
                        ...
                        <div className="desktop:w-[40%]">
                            <div className=" h-auto mobile:mx-2 desktop:mr-4 my-4 py-2 bg-white rounded-[10px] border border-[#C73659]" >
                           ...
                           <div className="flex h-auto mobile:mx-2 desktop:mr-4 my-4 py-2 bg-white rounded-[10px] border border-[#C73659]" >
                        ...
                        <div className="mobile:block desktop:hidden">
                            <div className="h-auto mobile:mx-2 desktop:ml-4 my-4 bg-white rounded-[10px] border border-[#C73659]" >
                                <div className='h-5 text-base font-bold text-black p-4'>Tất cả</div>
                                <div className='flex flex-col mt-4 items-center justify-center'>
                                    <ProductCardInOrderDetail 
                                        products={product}
