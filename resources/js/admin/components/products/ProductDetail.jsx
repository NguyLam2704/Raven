                ...
                <div className="border bg-white rounded-lg border-[#C73659]">     
                    ...
                    <div className="desktop:flex">
                        ...
                        <div className="desktop:w-[60%]">
                            <div className="desktop:w-[600px] h-auto mobile:mx-2 desktop:ml-4 my-4 bg-white rounded-[10px] border border-[#C73659]" >
                           ...
                           <div className="desktop:w-[600px] desktop:h-[630px] mobile:mx-2 desktop:ml-4 my-4 bg-white rounded-[10px] border border-[#C73659]" >
                        ...
                        <div className="desktop:w-[40%] mobile:px-2 desktop:pr-2 pt-4 flex-col">
                            <div  className="h-auto mb-1 bg-white rounded-[10px] border border-[#C73659]" >
                                <BieuDoCot data={chart.doanhthu}/>
                            </div>
                            <div  className='flex w-full justify-between mr-4'>
                                <div  className=" flex-1 w-1/2 h-auto bg-white rounded-[10px] mr-[1px] border border-[#C73659]">
                                    <BieuDoTron data={chart.color} title={"Màu sắc"}/>
                                </div>
                                <div  className="flex-1 w-1/2 h-auto bg-white rounded-[10px] ml-[1px] border border-[#C73659]">
